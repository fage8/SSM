...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_list?t="+new Date().getTime(),//加后面的时间就是防止浏览器缓存
	        idField:'id', 
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		<tr>
	    			<td style="width:50px">年级名:</td>
	    			<td>
	    				<input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, validType:'repeat', missingMessage:'请填写姓名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
	    			<td><textarea id="add_remark" class="easyui-textbox"  style="width: 200px; height: 150px;" name="remark" data-options="multiline:true" /></textarea></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
